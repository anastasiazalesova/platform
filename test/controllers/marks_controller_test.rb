...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { date: @mark.date, discipline_id: @mark.discipline_id, value: @mark.value } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { date: @mark.date, discipline_id: @mark.discipline_id, value: @mark.value } }
