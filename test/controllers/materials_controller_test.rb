...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { discipline_id: @material.discipline_id, name: @material.name, url: @material.url } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { discipline_id: @material.discipline_id, name: @material.name, url: @material.url } }
